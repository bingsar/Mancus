                  ...
                  <div className={styles.nav__wrap}>
                      ...
                      <div className={styles.contact__wrap}>
                          <div className={styles.twitter}>
                              <a href="mailto:JK@mancusgroup.com" target="_blank">
                          ...
                          <div className={styles.twitter}>
                              <a href="https://twitter.com/JanKabin" target="_blank">
                                  <div className={styles.icon__wrap}>
                          ...
                          <div className={styles.twitter}>
                              <a href="https://www.linkedin.com/in/jan-kabin-774846244/" target="_blank">
                                  <div className={styles.icon__wrap}>
